...
# Output .text file
with open("{0} Temperature Regression Parameters.txt".format(data_filepath), 'w+') as output:
...
fig.suptitle("Temperature over Time Regression Comparison, Data File: {0}".format(data_filepath))
